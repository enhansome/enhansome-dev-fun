...
* [DICSS](https://github.com/letsgetrandy/DICSS) ⭐ 1,345 | 🐛 31 | 🌐 JavaScript | 📅 2015-12-18 - Directly injected CSS.
...
* [termagitchi](https://github.com/TevvvB/termagitchi) ⭐ 14 | 🐛 2 | 🌐 Go | 📅 2026-09-09 - A gacha machine bolted to `git status`: every coding-agent session hatches its own ASCII creature, and the creature gets visibly sadder the longer you leave things uncommitted.
...
* [FizzBuzzEnterpriseEdition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,849 | 🐛 546 | 🌐 Java | 📅 2024-07-15 - A no-nonsense implementation of FizzBuzz made by serious businessmen for serious business purposes.

## JavaScript

* [not-paid.js](https://github.com/kleampa/not-paid) ⭐ 15,701 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-08 - Add opacity to the body tag and increase it every day until their site completely fades away. 💸
* [jsFuck](https://github.com/aemkei/jsfuck) ⭐ 8,599 | 🐛 38 | 🌐 JavaScript | 📅 2025-03-10
...
* [is-thirteen](https://github.com/jezen/is-thirteen) ⭐ 6,176 | 🐛 419 | 🌐 JavaScript | 📅 2026-01-29 - Check if a number is equal to 13.
* [FuckitJS](https://github.com/mattdiamond/fuckitjs) ⭐ 4,184 | 🐛 35 | 🌐 JavaScript | 📅 2023-07-01 - JavaScript Error Steamroller.
* [Echochamber.js](https://github.com/tessalt/echo-chamber-js) ⭐ 4,106 | 🐛 12 | 🌐 JavaScript | 📅 2019-05-10 - Commenting without the comments - providing a single-sided user comments just stored in local storage.
...
* [ArnoldC](https://github.com/lhartikk/ArnoldC) ⭐ 6,886 | 🐛 73 | 🌐 Scala | 📅 2024-01-31 - Arnold Schwarzenegger based programming language.
* [Vigil](https://github.com/munificent/vigil) ⭐ 3,038 | 🐛 26 | 🌐 Python | 📅 2022-09-26 - Vigil, the eternal morally vigilant programming language.
...
* [Corporate Bullshit/Buzzword Generator API](https://github.com/sameerkumar18/corporate-bs-generator-api) ⭐ 357 | 🐛 2 | 🌐 JavaScript | 📅 2023-04-13 - Corporate bullshit generator that randomly picks out phrases, which can help your application get ahead in an industry where spin, buzzwords and vagueness reign supreme.
...
* [Github XP](https://github.com/martenbjork/github-xp) ⭐ 2,653 | 🐛 15 | 📅 2025-11-01 - Microsoft + GitHub = ❤️. Make it official by giving your GitHub experience some Windows XP flair.
* [Cloud to butt](https://github.com/panicsteve/cloud-to-butt) ⭐ 1,502 | 🐛 19 | 🌐 JavaScript | 📅 2024-02-19 - Chrome extension that replaces occurrences of 'the cloud' with 'my butt'.
...
* [Chucknorris](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#chucknorris) ⭐ 189,653 | 🐛 345 | 🌐 Shell | 📅 2026-09-10 - A Chuck Norris fortune plugin for ZSH.
* [genact](https://github.com/svenstaro/genact) ⭐ 12,186 | 🐛 17 | 🌐 Rust | 📅 2026-09-01 - 🌀 A nonsense activity generator for your shell.
...
* [cmatrix](https://github.com/abishekvashok/cmatrix) ⭐ 5,238 | 🐛 83 | 🌐 C | 📅 2024-08-21 - Make it digital rain in your terminal like The Matrix.
* [lolcommits](https://github.com/mroth/lolcommits) ⭐ 4,819 | 🐛 40 | 🌐 Ruby | 📅 2026-09-05 - Git-based selfies for software developers.
* [sl](https://github.com/mtoyoda/sl) ⭐ 3,329 | 🐛 36 | 🌐 C | 📅 2024-06-11 - SL (Steam Locomotive) runs across your terminal when you type "sl" as you meant to type "ls".
...
* [sudont](https://github.com/cbondurant/sudont) ⭐ 18 | 🐛 0 | 🌐 C | 📅 2018-01-05 - Grants superuser permission, then does nothing.
...
* [No Code](https://github.com/kelseyhightower/nocode) ⭐ 65,718 | 🐛 4,719 | 🌐 Dockerfile | 📅 2024-08-07 - The best way to write secure and reliable applications. Write nothing; deploy nowhere.
...
* [πfs](https://github.com/philipl/pifs) ⭐ 7,525 | 🐛 60 | 🌐 C | 📅 2026-04-01 - π contains every possible digit sequence in existence.  I'm sure your data is in there *somewhere*.
* [parrot.live](https://github.com/hugomd/parrot.live) ⭐ 4,469 | 🐛 4 | 🌐 JavaScript | 📅 2026-01-17 - 🐦 Bringing animated parrots to terminals everywhere.
