...
* [termagitchi](https://github.com/TevvvB/termagitchi) ⭐ 15 | 🐛 2 | 🌐 Go | 📅 2026-09-09 - A gacha machine bolted to `git status`: every coding-agent session hatches its own ASCII creature, and the creature gets visibly sadder the longer you leave things uncommitted.
...
* [FizzBuzzEnterpriseEdition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,855 | 🐛 546 | 🌐 Java | 📅 2024-07-15 - A no-nonsense implementation of FizzBuzz made by serious businessmen for serious business purposes.
...
* [Echochamber.js](https://github.com/tessalt/echo-chamber-js) ⭐ 4,105 | 🐛 12 | 🌐 JavaScript | 📅 2019-05-10 - Commenting without the comments - providing a single-sided user comments just stored in local storage.
...
* [ArnoldC](https://github.com/lhartikk/ArnoldC) ⭐ 6,881 | 🐛 73 | 🌐 Scala | 📅 2024-01-31 - Arnold Schwarzenegger based programming language.
...
* [Corporate Bullshit/Buzzword Generator API](https://github.com/sameerkumar18/corporate-bs-generator-api) ⭐ 358 | 🐛 2 | 🌐 JavaScript | 📅 2023-04-13 - Corporate bullshit generator that randomly picks out phrases, which can help your application get ahead in an industry where spin, buzzwords and vagueness reign supreme.
...
* [Chucknorris](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#chucknorris) ⭐ 189,704 | 🐛 337 | 🌐 Shell | 📅 2026-09-13 - A Chuck Norris fortune plugin for ZSH.
* [genact](https://github.com/svenstaro/genact) ⭐ 12,192 | 🐛 16 | 🌐 Rust | 📅 2026-09-01 - 🌀 A nonsense activity generator for your shell.
...
* [cmatrix](https://github.com/abishekvashok/cmatrix) ⭐ 5,243 | 🐛 83 | 🌐 C | 📅 2024-08-21 - Make it digital rain in your terminal like The Matrix.
* [lolcommits](https://github.com/mroth/lolcommits) ⭐ 4,819 | 🐛 40 | 🌐 Ruby | 📅 2026-09-11 - Git-based selfies for software developers.
* [sl](https://github.com/mtoyoda/sl) ⭐ 3,330 | 🐛 37 | 🌐 C | 📅 2024-06-11 - SL (Steam Locomotive) runs across your terminal when you type "sl" as you meant to type "ls".
...
* [No Code](https://github.com/kelseyhightower/nocode) ⭐ 65,722 | 🐛 4,718 | 🌐 Dockerfile | 📅 2024-08-07 - The best way to write secure and reliable applications. Write nothing; deploy nowhere.
...
* [parrot.live](https://github.com/hugomd/parrot.live) ⭐ 4,472 | 🐛 4 | 🌐 JavaScript | 📅 2026-01-17 - 🐦 Bringing animated parrots to terminals everywhere.
